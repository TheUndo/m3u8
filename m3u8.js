					...
					var req = fetch(m3u8)
						...
						.then(function(d) {
							...
							recur = new RecurseDownload(mapped, function(data) {
								...
								try {
								document.body.insertAdjacentHTML("afterbegin", `true2 ${_this.ios}`);
							} catch(e) {
								document.write(e);
							}
						...
						.then(function(d) {
							...
							var blobs = map(d, function(v, j) {
								return new Promise(function (resolve, reject) {
									...
									var read = reader.readAsArrayBuffer(new Blob([v], {type: "octet/stream"})); // IE can't read Blob.arrayBuffer :(
